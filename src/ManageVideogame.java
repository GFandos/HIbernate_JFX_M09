...
public class ManageVideogame {
    ...
    public static void main(String[] args) {
      ...
      /* Add few employee records in database */
        Integer v1 = ME.addVideogame("Crysis", 1, 15);
        Integer v2 = ME.addVideogame("Dark Souls", 4, 20);
        Integer v3 = ME.addVideogame("Resident Evil VII", 1, 60);
    ...
    public Integer addVideogame(String title, int players, int price){
        ...
        try{
            ...
            Videogame videogame = new Videogame(title, players, price);
